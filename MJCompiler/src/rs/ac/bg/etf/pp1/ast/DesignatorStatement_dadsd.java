...
public class DesignatorStatement_dadsd extends DesignatorStatement {
    ...
    public DesignatorStatement_dadsd (Designator Designator, Assignop Assignop, Designator Designator1, Setop Setop, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_dadsd(\n");
