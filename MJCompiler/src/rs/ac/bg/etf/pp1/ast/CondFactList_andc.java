...
public class CondFactList_andc extends CondFactList {

    private CondFactList CondFactList;
    private CondFact CondFact;

    public CondFactList_andc (CondFactList CondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactList_andc(\n");
